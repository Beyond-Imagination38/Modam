...
1. **Target Customer 1: 대학생 000 (24세, 여성)**
    - 책을 좋아하고 깊이 있는 사고를 즐김
    - 마이너 장르를 선호해 대중적인 모임과는 잘 맞지 않음
    - 낯선 사람들과의 대면 토론에 심리적 부담을 느낌
    - 바쁜 학업 일정으로 정기적인 오프라인 모임 참여 어려움
    - 익명 기반 온라인 소통을 선호
    - 모임 운영이나 발제문 작성 등 리더십 역할에는 부담을 느낌
    - 체계적인 독서 기록 정리에는 익숙하지 않음
2. **Target Customer 2: 직장인 000 (30세, 남성)**
    - 지방 소도시 거주, 주로 재택근무
    - 자기계발/비즈니스 서적을 즐겨 읽음
    - 업무 효율을 중시하며 실용적인 지식 공유에 관심
    - 지역에 독서모임이 없어 오프라인 참여가 번거로움
    - 온라인 모임 참여에는 긍정적이지만, 익명 기반 채팅 환경에서 비속어나 공격적인 언행이 발생할까봐 불안감을 느낀 경험이 있음

**Pain Points**

- 시간적, 물리적 제약:
    - 학업 일정과 시험, 과제 등으로 정기 오프라인 모임 참석이 어려움
    - 지방에 거주하여 모임 장소까지의 이동 시간·비용이 부담
- 심리적 부담감:
    - 대면 토론에서 자신의 의견을 말하는 것에 불안감과 부담을 느낌
- 모임 조직의 부담:
    - 스스로 모임을 주최하거나 운영하는 데 어려움
- 모임 성사 어려움:
    - 마이너 장르의 도서를 선호하여 취향이 맞는 참여자를 찾기 어려움
- 내용 정리의 어려움:
    - 토론 후 내용을 잘 기록하거나 구조화하지 못함, 회의처럼 요약·정리된 결과물을 원하는 수요가 있음
- 온라인 익명 채팅에 대한 불안감:
    - 자유로운 의견 표현을 원하지만, 비속어나 혐오 표현에 대한 걱정이 있음  |
